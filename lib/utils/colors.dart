...
const appBarColor = Color.fromRGBO(40, 60, 71, 1);
const webAppBarColor = Color.fromRGBO(26, 43, 53, 1);
const messageColor = Color.fromRGBO(5, 89, 200, 1);
const senderMessageColor = Color.fromRGBO(37, 45, 49, 1);
const tabColor = Color.fromRGBO(64, 151, 244, 1);
